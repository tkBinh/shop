                            ...
                            <li data-transition="boxfade" data-slotamount="20" class="active-revslide"
                                ...
                                <div class="slotholder" style="width:100%;height:100%;" data-duration="undefined"
                                    ...
                                    <div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover"
                                         ...
                                         src="source/image/slide/{{ $itemSlide->image }}"
                                         data-src="source/image/slide/{{ $itemSlide->image }}"
                                         style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url('source/image/slide/{{ $itemSlide->image }}'); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;">
                                    </div>
                                </div>
                            </li>
                        @endforeach
                    ...
                    <div class="col-sm-12">
                        <div class="beta-products-list">
                            ...
                            <div class="beta-products-details">
                                <p class="pull-left">Tìm thấy {{count($productNew)}} sản phẩm</p>
                                <div class="clearfix"></div>
                            </div>

                            <div class="row">
                                @foreach($productNew as $itemProductNew)
                                    <div class="col-sm-3">
                        ...
                        <div class="beta-products-list">
                            ...
                            <div class="beta-products-details">
                                <p class="pull-left">Tìm thấy {{count($productDiscount)}} sản phẩm</p>
                                <div class="clearfix"></div>
                            </div>

                            <div class="row">
                                @foreach($productDiscount as $itemProductDiscount)
                                    <div class="col-sm-3">
                                        <div class="single-item">
                                            <div class="ribbon-wrapper">
                                                <div class="ribbon sale">Sale</div>
